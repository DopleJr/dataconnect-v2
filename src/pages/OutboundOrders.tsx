...
const OutboundOrders: React.FC = () => {
  const columns = [
    ...
    { key: 'Creation_Date', label: 'Creation Date', query: 'out1.CREATED_TIMESTAMP' },
    ...
    { key: 'User', label: 'User', query: 'out13.UPDATED_BY' },
    { key: 'Confirmation_Date', label: 'Confirmation Date', query: 'out6.UPDATED_TIMESTAMP' },
    ...
    { key: 'TASK_ID', label: 'TASK ID', query: 'out13.TASK_ID' },
    { key: 'OLPN_ID', label: 'OLPN ID', query: 'out1.OLPN_ID' },
    { key: 'OLPN_ID2', label: 'OLPN ID2', query: '' },
